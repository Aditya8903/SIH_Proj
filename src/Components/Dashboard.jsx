...
const Dashboard = () => {
  return (
    <div className="flex h-full justify-center items-center text-richblack-100 ">
      {/* Generation */}
      <div className="flex-1 border border-white p-8 m-12 w-1/2 h-[300px]">
      ...
      <div className="flex-1 border border-white p-8 m-12 w-1/2 h-[300px]">
        ...
        <Link to="/VerifyCertificate" className="bg-blue-500 w-1/2 mx-auto hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded block text-center">
          Verify
        </Link>
      </div>
    </div>
